...
<body>
   ...
   <section class="video-form">
      ...
      <h1 class="heading"><?= $translations['upload_content'] ?></h1>

      <form action="" method="post" enctype="multipart/form-data">
         <p><?= $translations['video_status'] ?> <span>*</span></p>
         ...
         <p><?= $translations['video_title'] ?> <span>*</span></p>
         <input type="text" name="title" maxlength="100" required
            placeholder="<?= $translations['enter_video_title'] ?>" class="box">
         <p><?= $translations['video_description'] ?> <span>*</span></p>
         ...
         <p><?= $translations['video_playlist'] ?> <span>*</span></p>
         <select name="playlist" class="box" required>
            <option value="" disabled selected><?= $translations['select_playlist'] ?></option>
            <?php
            ...
            <?php
               ...
               echo '<option value="" disabled>' . $translations['no_playlist'] . '</option>';
            }
            ?>
         </select>
         <p><?= $translations['select_thumbnail'] ?> <span>*</span></p>
         <input type="file" name="thumb" accept="image/*" required class="box">
         <p><?= $translations['select_video'] ?> <span>*</span></p>
         <input type="file" name="video" accept="video/*" required class="box">
         <input type="submit" value="<?= $translations['upload_video'] ?>" name="submit" class="btn">
      </form>
