...
<head>
   ...
   <title><?php echo $translations["tutor's_profile"] ?></title>
...
<body>
   ...
   <section class="tutor-profile">
      ...
      <h1 class="heading"><?php echo $translations["profile_details"] ?></h1>
      ...
      <div class="details">
         ...
         <div class="flex">
            <p><?php echo $translations["total_playlists"] ?> <span><?= $total_playlists; ?></span></p>
            <p><?php echo $translations["total_videos"] ?><span><?= $total_contents; ?></span></p>
